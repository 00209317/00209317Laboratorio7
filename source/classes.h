...
enum parameters {TAU,KAPPA,LAMBDA,NI,PSI,DELTA,ETA,EXTERNAL_FORCE_X,EXTERNAL_FORCE_Y};
...
class mesh{
    ...
    public:
        //float u_bar,float nu, float rho, float f_x, float f_y
        void setParameters(float tau,float kappa, float lambda, float ni, float psi, float delta, float eta){
            parameters[TAU]= tau;
